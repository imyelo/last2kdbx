...
`,b=async(a,t="output.csv")=>{try{const l=(e=>{const a=r.Buffer.alloc(null==e?void 0:e.byteLength),t=new Uint8Array(e);for(let r=0;r<a.length;r++)a[r]=t[r];return a})(await a.arrayBuffer()),s=await(async a=>{var t,l;const s=n.parse(a.toString("utf8").trim(),{header:!0});p(s);const c=new e.Credentials(e.ProtectedValue.fromString(""),null),i=await e.Kdbx.create(c,"My new db"),u=o.uniq(null==(t=s.data)?void 0:t.map((e=>e.grouping))),d=o.object(u.map((e=>[e,i.createGroup(i.getDefaultGroup(),e)])));null==(l=s.data)||l.forEach((e=>{const a=i.createEntry(d[e.grouping]);a.fields.Title=e.name,a.fields.UserName=e.username,a.fields.Password=e.password,a.fields.URL=e.url,a.fields.Note=e.extra,a.pushHistory()})),p(i);const f=await i.save();return p(f),Promise.resolve(r.Buffer.from(f))})(l),c=new File([s],t,{type:"text/plain;charset=utf-8"});i.saveAs(c)}catch(l){u(l.message),console.error(l)}},h=()=>{const e=s.useCallback((e=>{e&&b(e,`${e.name.replace(/\.csv$/,"")}-${c(new Date,"YYYYMMDDhhmmss")}.kdbx`)}),[]);return s.createElement(g,null,s.createElement("div",{className:"title"},"Convert LastPass CSV to KDBX"),s.createElement(m,{className:"file",onChange:e}))};d.render(s.createElement(s.StrictMode,null,s.createElement(h,null)),document.getElementById("root"));
